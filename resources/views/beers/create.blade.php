...
@section('main-content')
    ...
    <form action="{{route('beers.store')}}" method="post" class="needs-validation" novalidate>
        ...
        <div class="form-group">
            ...
            <input type="text" name="alcohol_content" class="form-control" placeholder="Alcohol content" required><div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="text" name="description" class="form-control" placeholder="Description" required><div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="text" name="img_url" class="form-control" placeholder="Img URL" required>
            <div class="invalid-feedback">
